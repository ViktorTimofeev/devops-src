...
# =============================================================================
# Скрипт установки Oracle Database 11.2.0.4.0 с параметрами через URL
# Автор: DevOps Expert Team
# Версия: 1.1
# Описание: Установка Oracle с параметрами через URL параметры
# 
# Использование:
# curl -fsSL "https://raw.githubusercontent.com/ViktorTimofeev/devops-src/main/oracle/oracle-install-with-params.sh?sid=prod&db_name=PROD&sys_password=MyPass123!" | bash
# =============================================================================
...
# Основная функция
main() {
    log "Начинаем установку Oracle Database 11.2.0.4.0 с параметрами..."
...
# Скачивание и выполнение основного скрипта
